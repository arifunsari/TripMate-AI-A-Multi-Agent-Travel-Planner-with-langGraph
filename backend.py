...
def get_database_url():
    ...
    # Normalize a malformed URL if someone previously appended sslmode to the DB name.
    if "sslmode=require" in database_url and "?sslmode=require" not in database_url and "/" in database_url:
